...
- Le coordinate geografiche sono **sempre in gradi sessadecimali** (in input e in output); le proiettate in **metri**. Dipende dal CRS, non dalla direzione della conversione.
